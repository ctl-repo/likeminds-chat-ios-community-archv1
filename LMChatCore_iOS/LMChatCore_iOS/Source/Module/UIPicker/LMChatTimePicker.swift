...
public protocol LMChatTimePickerProtocol: AnyObject {
    func didSelectTime(at date: Date)
}

open class LMChatTimePicker: LMViewController {
    // MARK: UI Elements
    ...
    // MARK: Data Variables
    public weak var delegate: LMChatTimePickerProtocol?
    ...
    // MARK: configure
    open func configure(selecteDate: Date?, minimumDate: Date? = nil, delegate: LMChatTimePickerProtocol?) {
