...
public protocol LMChatGeneralPickerProtocol: AnyObject {
    func didSelectRowAt(index: [Int])
}

open class LMChatGeneralPicker: LMViewController {
    ...
    public weak var delegate: LMChatGeneralPickerProtocol?
    ...
    // MARK: configure
    open func configure(with data: ContentModel, delegate: LMChatGeneralPickerProtocol) {
...
extension LMChatGeneralPicker: UIPickerViewDataSource, UIPickerViewDelegate {
