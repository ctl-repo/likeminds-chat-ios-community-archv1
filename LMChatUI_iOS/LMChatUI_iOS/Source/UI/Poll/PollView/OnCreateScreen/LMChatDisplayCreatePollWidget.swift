//
//  LMChatDisplayCreatePollWidget.swift
//  LikeMindsChatUI
//
...
open class LMChatDisplayCreatePollWidget: LMBasePollOptionView {
    public struct ContentModel: LMBasePollOptionView.Content {
