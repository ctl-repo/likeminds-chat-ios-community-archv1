...
public protocol LMChatCreatePollViewProtocol: AnyObject {
    func onTapCrossButton()
    func onTapEditButton()
}

open class LMChatCreateDisplayPollView: LMBasePollView {
    public struct ContentModel: LMBasePollView.Content {
        ...
        public var options: [LMChatDisplayCreatePollWidget.ContentModel]
        
        public init(question: String, showEditIcon: Bool, showCrossIcon: Bool, expiryDate: Date, optionState: String, optionCount: Int, options: [LMChatDisplayCreatePollWidget.ContentModel]) {
    ...
    public weak var delegate: LMChatCreatePollViewProtocol?
    ...
    // MARK: configure
    open func configure(with data: ContentModel, delegate: LMChatCreatePollViewProtocol?) {
