//
//  LMChatCreatePollUserOptionWidget.swift
//  LikeMindsFeedUI
//
...
open class LMChatCreatePollUserOptionWidget: LMView {
    ...
    open private(set) lazy var downArrow: LMImageView = {
        let image = Constants.shared.images.downChevronArrowIcon.withConfiguration(UIImage.SymbolConfiguration(font: Appearance.shared.fonts.subHeadingFont1))
